...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_gateway_api"></a> [gateway\_api](#module\_gateway\_api) | ../modules/gateway-api | n/a |
...
| <a name="input_tags"></a> [tags](#input\_tags) | A map of tags to add to all resources. | `map(string)` | <pre>{<br>  "Service": "Gateway API"<br>}</pre> | no |
