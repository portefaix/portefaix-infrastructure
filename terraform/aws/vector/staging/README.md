...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_vector"></a> [vector](#module\_vector) | ../modules/vector | n/a |
...
| <a name="input_tags"></a> [tags](#input\_tags) | Tags for VPC | `map(string)` | <pre>{<br>  "Service": "Vector"<br>}</pre> | no |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_role_arn"></a> [role\_arn](#output\_role\_arn) | Role ARN for Vector |
