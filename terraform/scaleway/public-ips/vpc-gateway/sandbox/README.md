...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_vpc_gateway"></a> [vpc\_gateway](#module\_vpc\_gateway) | ../modules/vpc-gateway | n/a |
...
| <a name="input_tags"></a> [tags](#input\_tags) | The tags associated with the VPC Gateway publis IPs. | `list(string)` | <pre>[<br>  "terraform"<br>]</pre> | no |
